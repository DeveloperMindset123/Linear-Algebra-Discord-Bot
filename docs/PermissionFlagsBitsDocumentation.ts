/**
 * @This is nothing but a Reference file for PermissionFlagsBits
 * @NOTE Ignore any type errors, this is just to have the file open for reference, not really needed
 */
//@ts-nocheck
